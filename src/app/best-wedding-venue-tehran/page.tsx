...
const Page = () => {
  ...
  const blogData = {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "برای رزرو تالار بدون استرس، این نکات رو رعایت کنید.",
        lists: [
  ...
  useEffect(() => {
    document.title = "بهترین تالار عروسی تهران: چرا تالار ورسای انتخاب اول شماست؟";
        ...
        <div className="px-4 mx-auto py-2 rounded-lg my-2 width-full grid grid-cols-1 gap-4">
          <div className="col-span-2 mx-auto width-auto my-2 max-w-5xl rounded-lg">
            ...
            <div className="mx-auto width-auto my-2 px-1.5 py-1.5 rounded-lg text-center">
              ...
              <p className="p-2">
                دنبال یه تالار شیک و به‌صرفه تو تهران هستید؟ تالار ورسای با دکور لاکچری و خدمات حرفه‌ای، شب عروسی‌تون رو به‌یادموندنی می‌کنه.
              </p>
              ...
              <p className="p-2">
                تالار ورسای تو احمدآباد مستوفی با سالن‌های متنوع، منوی غذایی باکیفیت و پکیج‌های اقتصادی، بهترین انتخاب برای عروسی یا عقد تو تهرانه.
              </p>
              ...
              <div className="mx-auto width-auto my-8 px-4 py-6 bg-white rounded-lg shadow-md">
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-gray-50 p-5 rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                      یه تالار خوب باید فضای شیک، دسترسی راحت و غذای باکیفیت داشته باشه تا شب عروسی‌تون به‌یادموندنی بشه.
                    </p>
                    <div className="bg-green-50 p-4 rounded-lg mb-4">
                      ...
                      <ul className="list-disc pr-5 space-y-2">
                        ...
                        <li>کیفیت غذا و پذیرایی: غذاهای خوشمزه و سرویس حرفه‌ای.</li>
                    ...
                    <div className="bg-green-100 p-4 rounded-lg">
                      ...
                      <p>
                        یه زوج تو ورسای عروسی گرفتن و مهموناشون هنوز از دکور قصرگونه و نورپردازی حرفه‌ای حرف می‌زنن.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-5 rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                      تالار ورسای با دکور لاکچری، منوی متنوع و خدمات حرفه‌ای، مراسم‌تون رو به یه تجربه رویایی تبدیل می‌کنه.
                    </p>
                    <div className="bg-green-50 p-4 rounded-lg mb-4">
                      <h5 className="font-bold mb-2">چرا ورسای؟</h5>
                      <ul className="list-disc pr-5 space-y-2">
                        <li>دکوراسیون قصرگونه: لوسترهای کریستالی و سالن‌های شیک.</li>
                    ...
                    <div className="bg-green-100 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">مثال واقعی:</h5>
                      <p>
                        یه زوج عروسی 1000 نفره تو سالن اصلی ورسای گرفتن و مهموناشون از طعم باقالی‌پلو و پذیرایی حرفه‌ای هنوز تعریف می‌کنن.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="my-12 bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <div className="space-y-6">
                      <div className="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p className="pr-4">
                          تو احمدآباد مستوفی، نزدیک اتوبان آزادگان با پارکینگ 700 خودرو.
                        </p>
                      </div>
                      <div className="bg-white p-4 rounded-lg shadow-sm">
                        <h4 className="font-bold text-lg mb-2">
                        ...
                        <p className="pr-4">
                          بستگی به پکیج و تعداد مهمونا داره. به سایت ورسای سر بزنید.
                        </p>
                      </div>
                      <div className="bg-white p-4 rounded-lg shadow-sm">
                        <h4 className="font-bold text-lg mb-2">
                  ...
                  <div className="my-12 bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                      تالار ورسای با فضای لاکچری و خدمات حرفه‌ای، شب عروسی‌تون رو فراموش‌نشدنی می‌کنه. همین حالا رزرو کنید!
                    </p>
