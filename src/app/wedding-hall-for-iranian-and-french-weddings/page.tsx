              ...
              <div className="mx-auto width-auto my-8 px-4 py-6 bg-white rounded-lg shadow-md">
                ...
                <div className="mx-auto width-auto my-8 px-4 py-6 bg-white rounded-lg shadow-md">
                  ...
                  <div className="my-8">
                    ...
                    <p className="mb-4">
                      شاید بپرسین مگه شاتو دو ورسای خدمات فرانسوی هم داره؟
                      راستش نه به اون شکل کلاسیک، ولی ما یه چیز مهم‌تر داریم:
                      توانایی خلق تجربه! هر عروسی که تا امروز اینجا برگزار شده،
                      یه داستان منحصربه‌فرد بوده. ما به سلیقه و رویاهای شما گوش
