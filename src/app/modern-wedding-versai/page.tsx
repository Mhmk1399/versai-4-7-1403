  ...
  const blogData = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "برای یه عروسی بدون استرس، این مراحل رو دنبال کنید.",
        lists: [
      ...
      },
      {
        ...
        content: "چندتا ایده‌ی خاص براتون داریم که مراسم‌تون رو متفاوت می‌کنه.",
        lists: [
          ...
          <div className="col-span-2 mx-auto width-auto my-2 max-w-5xl rounded-lg">
            ...
            <div className="mx-auto width-auto my-2 px-1.5 py-1.5 rounded-lg text-center">
              <h1
                ...
                id="contentTitle"
              >
                عروسی‌های مدرن و هماهنگ با متد روز چجوریه؟ رزرو تالار ورسای برای
                یک شب به‌یادموندنی!
              </h1>

              <p className="p-2">
                دنبال یه عروسی شیک و مدرن هستید؟ تالار ورسای با دکور مینیمال و
                خدمات امروزی، شب عروسی‌تون رو به یه تجربه‌ی خاص تبدیل می‌کنه.
              </p>
              ...
              <p className="p-2">
                تالار ورسای با سالن‌های لاکچری، تکنولوژی‌های جدید و منوی
                خلاقانه، بهترین جا برای یه عروسی مدرن و ترندیه. همه‌چیز برای یه
                شب رویایی آماده‌ست!
              </p>
              ...
              <div className="mx-auto width-auto my-8 px-4 py-6 bg-white rounded-lg shadow-md">
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-gray-50 p-5 rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                      عروسی‌های مدرن با دکور شیک، تکنولوژی‌های جدید و سرگرمی‌های
                      خلاقانه، بازتاب سلیقه‌ی زوج‌های امروزیه.
                    </p>
                    <div className="bg-green-100 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">مثال واقعی:</h5>
                      <p>
                        تو تالار ورسای، یه زوج با دکور مینیمال و پروجکشن مپینگ،
                        یه عروسی برگزار کردن که مهموناشون هنوز ازش حرف می‌زنن.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-5 rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                      یه عروسی مدرن باید شیک، خلاقانه و هماهنگ با ترندهای جهانی
                      باشه.
                    </p>
                    <div className="bg-green-50 p-4 rounded-lg mb-4">
                      ...
                      <ul className="list-disc pr-5 space-y-2">
                        ...
                        <li>
                          فناوری‌های جدید: پروجکشن مپینگ و کابین عکاسی 360.
                        </li>
                    ...
                    <div className="bg-green-100 p-4 rounded-lg">
                      ...
                      <p>
                        تو ورسای، می‌تونیم یه دکور مینیمال با تم سفید و طلایی و
                        نورپردازی مخفی براتون طراحی کنیم که انگار تو یه کاخ
                        مدرنید.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-5 rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                      تالار ورسای با فضای لاکچری و تیم حرفه‌ای، همه‌چیز رو برای
                      یه عروسی مدرن آماده کرده.
                    </p>
                    <div className="bg-green-50 p-4 rounded-lg mb-4">
                  ...
                  <div className="my-12 bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <div className="space-y-6">
                      <div className="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p className="pr-4">
                          تمرکز روی سادگی، تکنولوژی و خلاقیت. تو ورسای هر مدل
                          عروسی رو می‌تونید برگزار کنید.
                        </p>
                      </div>
                      <div className="bg-white p-4 rounded-lg shadow-sm">
                        <h4 className="font-bold text-lg mb-2">
                  ...
                  <div className="my-12 bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <p className="mb-4">
                      تالار ورسای با فضای لاکچری و خدمات مدرن، عروسی‌تون رو به
                      یه خاطره‌ی خیره‌کننده تبدیل می‌کنه. همین حالا رزرو کنید!
                    </p>
