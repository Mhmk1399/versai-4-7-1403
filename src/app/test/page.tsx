...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 bg-black backdrop-blur-sm z-50 w-full shadow-sm mt-4">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Desktop Menu */}
          <div className=" lg:flex flex-row items-center space-x-8">
            {navItems.map((item, index) => (
              ...
              >
                <Link href={item.href}>
                  <span className="text-black hover:text-gold font-medium text-base transition-colors">
                    {item.title}
                  </span>
          ...
          >
            <div className="px-4 py-2 space-y-2">
              {navItems.map((item, index) => (
                ...
                >
                  <Link href={item.href}>
                    <span className="block py-3 text-black hover:text-gold font-medium transition-colors">
                      {item.title}
                    </span>
                  </Link>
                </motion.div>
